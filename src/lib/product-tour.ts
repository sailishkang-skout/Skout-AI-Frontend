...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: "Capture real won and lost deals with competitor, reason, and region so regional intelligence unlocks from GTM evidence.",
    details: [
      "Add deals as your team closes or loses opportunities",
      "Feeds competitive positioning and regional brief gates",
      "Target at least four real deals for full regional unlock",
    ],
  },
  {
    id: "incidents",
    ...
    title: "Incidents",
    body: "Track open platform incidents, severity, and resolution status in one admin view.",
    details: [
      "Owner/admin only — members should see a clear access denied",
      "Pairs with Control Plane for integration and Dexter governance",
      "Use during deploys or provider outages to communicate status",
    ],
  },
  {
    id: "revenue-intelligence",
    target: "nav-revenue-intelligence",
    href: "/admin/revenue",
    title: "Revenue intelligence",
    body: "Executive revenue hub — CRO summary, forecast variance, and links into reporting and CRM intelligence.",
    details: [
      "Compare pipeline value by currency and stage",
      "Jump to CRO Copilot or reporting from the same hub",
      "Owner/admin only for sensitive rollup data",
    ],
  },
  {
    id: "control-plane",
    target: "nav-control-plane",
    href: "/admin/control-plane",
    title: "Enterprise Control Plane",
    body: "Audit trail, integration health, Dexter pending approvals, journey metrics, and open incidents in one place.",
    details: [
      "Review recent audit events and integration degradation",
      "Clear Dexter governance blockers before scaling automation",
      "Links to compliance and Dexter Command Center",
    ],
  },
  {
    id: "model-performance",
    target: "nav-model-performance",
    href: "/admin/model-performance",
    title: "Model performance",
    body: "Monitor AI model quality signals and drift for workspace-facing copilots.",
    details: [
      "Owner/admin ops view — not required for day-to-day SDR work",
      "Use when investigating bad Dexter or NBA suggestions",
      "Pairs with Policy Gateway for safe automation modes",
    ],
  },
  {
    id: "compliance",
    ...
    body: "Manage suppressions, consent records, and data subject requests for GDPR-style compliance.",
    details: [
      "Add email/phone suppressions with audit trail",
      "Review workspace consent enrollments",
      "Submit and track DSAR access or deletion requests",
    ],
  },
  {
    id: "sso",
